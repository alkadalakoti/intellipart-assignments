...
public class ReadProperties {
		...
		public void swagDemoPage() throws IOException, InterruptedException
		{
			...
			FileInputStream ip=new FileInputStream("D:/Automation/Javafirstprogram/src/module9/config.properties");
			prop.load(ip);
			...
			//URL
					...
					System.out.println(BrowserName);
					 ...
					 if(BrowserName.equalsIgnoreCase("Chrome"))
					  ...
					  {
						//Launch Chrome Browser 
							System.setProperty("webdriver.chrome.driver","D:\\Automation\\geckodriver.exe");
					  ...
					  {
						//Launch Chrome Browser 
							System.setProperty("webdriver.chrome.driver","D:\\Automation\\edgedriver.exe");
